...
const UserProfile = () => {
    ...
    return (
        <Box width={"100%"} display={'flex'}>
            ...
            <Fragment>      {""}
                {user && <Box flexDirection={"column"} justifyContent={"center"} alignItems={"center"} width={"15%"} padding={3}>
                ...
                {bookings &&
                    (<Box width={"70%"} display={"flex"} flexDirection={"column"}>
                        <Typography variant={"h4"} textAlign={"center"} padding={2}>Your Bookings</Typography>
